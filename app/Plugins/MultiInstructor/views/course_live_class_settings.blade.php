        ...
        <div class="card-body">
            ...
            <form action="" method="post">
                ...
                <div class="form-group row {{ $errors->has('live_class.schedule') ? ' has-error' : '' }}">
                    <label for="schedule" class="col-md-4">Live Schedule </label>
                    ...
                    <div class="col-md-6">
                        ...
                        @if ($errors->has('live_class.schedule'))
                            <span class="invalid-feedback"><strong>This field is required</strong></span>
                        @endif
                    </div>
                </div>

                <div class="form-group row {{ $errors->has('live_class.note_to_student') ? ' has-error' : '' }}">
                    <label for="note_to_student" class="col-md-4"> Note to Student </label>
                ...
                <div class="form-group row {{ $errors->has('live_class.zoom_meeting_id') ? ' has-error' : '' }}">
                    <label for="zoom_meeting_id" class="col-md-4">Zoom Meeting ID </label>
                ...
                <div class="form-group row {{ $errors->has('live_class.zoom_meeting_password') ? ' has-error' : '' }}">
                    <label for="zoom_meeting_password" class="col-md-4">Zoom Meeting Password </label>
                ...
                <div class="col-md-6 offset-md-4">
                    <button type="submit" class="btn btn-danger" name="save" value="save"> <i class="la la-save"></i> {{__t('save')}}</button>
                    <button type="submit" class="btn btn-danger"  name="save" value="save_next"> <i class="la la-save"></i> {{__t('save_next')}}</button>
                </div>
