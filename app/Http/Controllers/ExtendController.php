...
class ExtendController extends Controller
{
    ...
    public function plugins(){
        $title = __a('plugins');
        $plugins = app('PikseraPlugins')->getPlugins();
        $extended_products = (array) $this->extended_products();
        $extended_plugins = array_get($extended_products, 'plugin');

        return view('admin.extend.plugins', compact('title', 'plugins', 'extended_plugins'));
    }
    ...
    public function findPlugins(){
        ...
        return view('admin.extend.find_plugins', compact('title', 'extended_plugins'));
    }
    ...
    public function themes(){
        ...
        return view('admin.extend.themes', compact('title', 'installed_themes'));
    }
    ...
    public function findThemes(){
        ...
        return view('admin.extend.find_themes', compact('title', 'themes'));
    }
    ...
    public function design(){
        ...
        return view('admin.installations.step_four', compact('title', 'installed_themes'));
    }
    ...
    public function findDesign(){
        ...
        return view('admin.installations.step_four', compact('title', 'themes'));
    }
    ...
    public function extended_products(){
        $products = Cache::remember('child_products', now()->addDays(1), function () {
            try {
                $response = Http::get(config('app.products_api'), ['unique_slug' => 'piksera-lms']);
