...
class CategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['categories'] = Category::whereStep(0)->with('sub_categories', 'sub_categories.sub_categories')->orderBy('category_name', 'asc')->paginate(4);
    ...
    public function show($slug){
        ...
        return view(('front.categories.view'), compact('title', 'category'));
    }

    public function home(){
        $title = __t('categories');

        return view(('front.categories.index'), compact('title'));
    }
