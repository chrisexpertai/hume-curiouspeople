...
class Attempt extends Model
{
    ...
    public function getStatusHtmlAttribute()
    {
        ...
        $html = "<span class='badge text-dark payment-status-{$this->status} badge-{$statusClass}'> <i class='la la-{$iclass}'></i> {$this->status}</span>";
    ...
    public function getTotalCorrectedAttribute()
    {
