/****************************************************************************
 * piksera LMS v1.7.0
 * Learning Management System by piksera
 * @package FileManager
 * Copyright 2024 | piksera | https://piksera.com
 ****************************************************************************/
        ...
        $(document).on('click', 'a[data-toggle="filemanager"]', function (e) {
            ...
            $(document).on('click', '#button-clear', function () {
                ...
                if (!$element.closest('.image-wrap').hasClass('media-btn-wrap')) {
                    $element.html('<img src="' + pageData.home_url + '/assets/images/placeholder-image.png" alt="" class="img-thumbnail">');
                }
