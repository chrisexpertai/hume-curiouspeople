...
@section('page-header-right')
    ...
    <a href="{{route('withdraws', ['status' => 'success'])}}" class="btn btn-primary ml-2" > <i class="la la-check-circle"></i> Success</a>
    <a href="{{route('withdraws', ['status' => 'rejected'])}}" class="btn btn-danger ml-2" > <i class="la la-exclamation-circle"></i> Rejected</a>
    ...
    <div class="withdraws-list-wrap">
        ...
        <form action="" method="get">
            ...
            @if($withdraws->count() > 0)
                ...
                <p class="text-muted my-3"> <small>{{ tr('Showing') }} {{$withdraws->count()}} from {{$withdraws->total()}} {{ tr('results') }}</small> </p>
