...
<div class="page-content-wrapper border">
    ...
    <div class="row">
        <div class="col-12">
            <h1 class="h3 mb-2 mb-sm-0">{{ tr('Payments') }}</h1>
        </div>
    </div>
    ...
    <div class="card bg-transparent">
        ...
        <div class="card-footer bg-transparent p-0">
            <div class="d-sm-flex justify-content-sm-between align-items-sm-center">
                <p class="mb-0 text-center text-sm-start">Showing {{ $payments->firstItem() }} to {{ $payments->lastItem() }} of {{ $payments->total() }} entries</p>
                {{ $payments->links() }}
            </div>
        </div>
        <!-- Card footer END -->
