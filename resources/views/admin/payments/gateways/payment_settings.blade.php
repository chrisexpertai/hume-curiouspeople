        ...
        <form action="{{ route('save_settings') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    ...
                    <p class="text-muted"> <small>{{ tr('If disable, admin will get all payments') }}</small> </p>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    ...
                    <p class="text-muted"> <small>{{ tr('How much earning will get the admin from each payment. Define the share in the percentage') }} </small> </p>
                </div>
            </div>

            <div class="form-group row">
                <label class="col-sm-3 col-form-label">{{ tr('Instructor Share') }} %</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="instructor_share_input" name="instructor_share" value="{{get_option('instructor_share')}}">
                    <p class="text-muted"> <small> {{ tr('This share amount will get instructor') }} </small> </p>
            ...
            <div class="form-group row">
                <label class="col-sm-3 col-form-label">{{ tr('Fees') }}</label>
                <div class="col-sm-6">
                        ...
                        <div>
                            <p class="mb-1">
                                <select class="form-control" name="charge_fees_type">
                                    <option value="">{{ tr('Select Fees Type') }}</option>
                    ...
                    <p class="text-muted my-3"> <small> {{ tr('You can charge an additional fees, like platform charge, or payment gateway charge.') }} </small> </p>
                </div>
            </div>
