...
<div class="page-content-wrapper border">
    ...
    <div class="col-xl-9">
        ...
        <div class="tab-content">
                ...
                <div class="tab-pane nav nav-tabs show active" id="tab-1" role="tabpanel">
