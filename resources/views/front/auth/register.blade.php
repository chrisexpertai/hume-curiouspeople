...
@section('content')
    @php
        $instructor_can_register = get_option('lms_options.lms_options.instructor_can_register');
    @endphp
                        ...
                        <div class="row my-5">
                            <div class="col-sm-10 col-xl-8 m-auto">
                                ...
                                <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <input id="name" type="text"
                                                ...
                                                placeholder="{{ __t('name') }}" name="name" value="{{ old('name') }}"
                                                required autofocus>
                                        </div>
                                        @if ($errors->has('name'))
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <input type="email" class="form-control border-0 bg-light rounded-end ps-1"
                                                placeholder="{{ __t('e_mail') }}" id="email" name="email"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <input type="password" class="form-control border-0 bg-light rounded-end ps-1"
                                                placeholder="{{ __t('password') }}" id="password" name="password"
                                                required>
                                        </div>
                                    ...
                                    <!-- Confirm Password -->
                                    <div class="mb-4">
                                        <label for="password-confirm" class="form-label">{{ __t('confirm_password') }}
                                            *</label>
                                        <div class="input-group input-group-lg">
                                            <span
                                                class="input-group-text bg-light rounded-start border-0 text-secondary px-3"><i
                                                    class="fas fa-lock"></i></span>
                                            <input type="password" class="form-control border-0 bg-light rounded-end ps-1"
                                                placeholder="{{ __t('confirm_password') }}" id="password-confirm"
                                    ...
                                    @if ($instructor_can_register)
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="input-group input-group-lg">
                                                <div class="col-md-6">
                                                    <label class="mr-3">
                                                        <input type="radio" name="user_as" value="student"
                                                            {{ old('user_as') ? (old('user_as') == 'student' ? 'checked' : '') : 'checked' }}>
                                                        {{ __t('student') }}
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="user_as" value="instructor"
                                                            {{ old('user_as') == 'instructor' ? 'checked' : '' }}>
                                                        {{ __t('instructor') }}
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="align-items-center mt-0">
                                        <div class="d-grid">
                                            <button class="btn btn-primary mb-0"
                                                type="submit">{{ __t('sign_up') }}</button>
                                        </div>
                                    </div>
                                </form>
                                <!-- Form END -->
                                ...
                                <div class="mt-4 text-center">
                                    <span>{{ tr('Already have an account?') }}<a href="{{ route('login') }}">
                                            {{ tr('Sign In here') }}</a></span>
                                </div>
                            </div>
                        </div> <!-- Row END -->
