...
<head>
    ...
    <meta name="author" content="{{ get_option('site_url') }}">
        ...
        <section class="pt-0 pt-lg-5 position-relative overflow-hidden my-auto">
            ...
            <div class="container position-relative">
                <div class="row g-5 align-items-center justify-content-center">
                    <div class="col-lg-5">
                        <!-- Title -->
                        <h1 class="mt-4 mt-lg-0">{{ tr('We are building something awesome!') }}</h1>
                        <!-- info -->
                        <p>{{ tr('Hey you! Piksera LMS is coming. We are doing our best to launch our website and we will be back soon.') }}
                        </p>
                        <!-- Progress bar -->
                        <div class="overflow-hidden mt-4">
                            <p class="mb-1 h6 fw-light text-start">{{ tr('Launch progress') }}</p>
                        ...
                        <form class="mt-4">
                            <!-- Info -->
                            <h6>{{ tr('Notify me when website is launched') }}</h6>
                            <div class="bg-body border rounded-2 p-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <button type="button"
                                        class="btn btn-blue mb-0 rounded-2">{{ tr('Notify Me!') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
