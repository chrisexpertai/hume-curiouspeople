    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const lightbox = GLightbox({
                ...
                loop: true,
                onOpen: function () {
                    // Initialize Plyr when the lightbox opens
                    const player = new Plyr('#player');
                },
                onClose: function () {
                    // Destroy Plyr instance when the lightbox closes (optional)
                    const player = Plyr.destroy('#player');
                }
            });
        });
    </script>
        ...
        <a href="{{$src_youtube}}" class="  text-danger btn-round " data-glightbox="" data-gallery="course-video">
...
<a href="{{$plyr_vimeo_url}}" class=" " data-glightbox="" data-gallery="course-video">
