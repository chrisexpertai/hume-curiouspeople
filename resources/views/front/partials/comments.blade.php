<div class="piksera-course-player-discussions">
            ...
            <div class="piksera-discussions">
                ...
                <div id="course-discussion-wrap">
                    <div class="discusion-calltoaction-wrap text-center py-4 my-4">
                        ...
                        <h3>{{ tr('Discussion') }}</h3>
                        <h5>{{ tr('Get answers directly from your instructor') }} <br /> {{ tr('if you have any questions about this topic.') }}</h5>
                    </div>
                    <div id="content-discussions-list-wrap">
                      @foreach($content->discussions as $discussion)

                      <div class="discussion-single-wrap  p-3 mb-4">
                          ...
                          @if($discussion->replies->count())
                              @foreach($discussion->replies as $reply)
                                  <div class="discussion-reply-wrap p-3 bg-white">
                                      <div class="discussion-user d-flex mb-4">
                                          <div class="reviewed-user-photo">
                  ...
                  @endforeach
                    ...
                    <div class="container pb-x py-4">
                        <form id="discussion-form" action="{{ route('ask_question') }}" method="post">
                            ...
                            <button type="submit" class="fav-button"><i class="la la-question-circle-o"></i> {{ __t('ask_question') }} </button>
                        </form>
                    </div>
