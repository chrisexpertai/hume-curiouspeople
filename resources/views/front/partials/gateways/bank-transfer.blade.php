<div id="checkoutBankPaymentWrap">
    ...
    <div class="bank-payment-instruction-wrap mt-2 mb-3 border p-4">
        <p>{{ tr('Write above Bank information, you need to pay at this bank account manually.') }}</p>
        <h6 class="">{{ tr('Make your payment directly to our bank account. Place your bank account information from where you sent money, write details as much as you can. We will confirm your payment after the funds have cleared in our account.') }}</h6>
    </div>
            ...
            <form action="{{route('bank_transfer_submit')}}" id="bankTransferForm" class="form-horizontal" method="post" enctype="multipart/form-data" > @csrf
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-purple btn-lg" id="bank-payment-form-btn">
                        <span class="enroll-course-btn-text mr-4 border-right pr-4">{{ tr('I have paid succesfully') }}</span>
