...
<body
    ...
    <div class="piksera-course-player-header">
        ...
        <div class="piksera-course-player-header__discussions" style="transition: all 0.3s linear 0s;">
            <span class="piksera-course-player-header__discussions-toggler">
                <span class="piksera-course-player-header__discussions-toggler__title"> {{ tr('Discussions') }} </span>
            </span>
            <span class="piksera-course-player-header__discussions-close-btn"></span>
        </div>
    </div>
    <span class="piksera-loader" style="display: none;">
        <img
            src="https://piksera.piksera.com/marketplace-elementor/wp-content/plugins/piksera-lms-learning-management-system/_core//assets/icons/global/loader.svg">
    </span>
