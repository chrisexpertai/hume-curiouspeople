<div class="section-item-form-html  p-4 border">
    ...
    <form class="curriculum-edit-lecture-form" action="{{route('update_lecture', [$item->course_id, $item->id])}}" method="post">
        ...
        <div id="lecture-basic" class="section-item-tab-wrap" style="display: block;">
            ...
            <div class="form-group d-flex align-items-center mt-3">
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="is_preview" name="is_preview" value="1" {{checked(1, $item->is_preview)}}>
        ...
        <div class="form-group text-right">
            ...
            <button type="submit" class=" btn btn-primary btn-edit-lecture"  name="save" value="save_next"> <i class="la la-save"></i> {{__t('save_'.$item->item_type)}}</button>
        </div>
