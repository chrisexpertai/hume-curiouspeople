...
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-md-4">
            <div class="card card-body mb-4">
                <h6 class="text-muted text-uppercase">{{ tr('Lifetime sales') }}</h6>
        ...
        <div class="col-12 col-md-4">
            <div class="card card-body mb-4">
                <h6 class="text-muted text-uppercase">{{ tr('Lifetime Earnings') }}</h6>
        ...
        <div class="col-12 col-md-4">
            <div class="card card-body mb-4">
                <h6 class="text-muted text-uppercase">{{ tr('Balance') }}</h6>
    ...
    @if( ! $user->withdraw_method)
        <div class="alert alert-warning">{{ tr('You did not select any withdraw method yet. Please select a withdraw method to process your withdraw.') }}</div>

        <a href="{{route('withdraw_preference')}}" class="btn btn-outline-info"> <i class="la la-cash-register"></i> {{ tr('Set Withdraw Method') }}</a>
    @else
