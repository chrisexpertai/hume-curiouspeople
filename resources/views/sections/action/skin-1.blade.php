					...
					<div class="row position-relative">
						...
						<div class="col-11 mx-auto position-relative">
							<div class="row align-items-center">
								<!-- Title -->
								<div class="col-lg-7">
									<h3 class="text-white">{{ tr('Become an Instructor!') }}</h3>
									<p class="text-white mb-3 mb-lg-0">{{ tr('Speedily say has suitable disposal add boy. On forth doubt miles of child. Exercise joy man children rejoiced. Yet uncommonly his ten who diminution astonished.') }}</p>
								</div>
								<!-- Content and input -->
								<div class="col-lg-5 text-lg-end">
									<a href="#" class="btn btn-outline-warning mb-0">{{ tr('Start Teaching Today') }}</a>
								</div>
							</div>
						</div>
					</div> <!-- Row END -->
