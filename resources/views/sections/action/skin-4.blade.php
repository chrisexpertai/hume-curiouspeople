					...
					<div class="row justify-content-center position-relative">
						...
						<div class="col-11 position-relative">
							<div class="row align-items-center">
								<!-- Title -->
								<div class="col-lg-7">
									<h3 class="text-white mb-0">{{ tr('Create your first online assessment') }}</h3>
									<p class="text-white small">{{ tr('Boost up your knowledge, grow your skill with the most reliable online courses and certifications') }}</p>
									<!-- List -->
									<ul class="list-inline mb-0 justify-content-center justify-content-lg-start">
										<li class="list-inline-item text-white me-2"> <i class="bi bi-check-circle-fill text-success me-2"></i>{{ tr('Free registration') }}</li>
										<li class="list-inline-item text-white me-2"> <i class="bi bi-check-circle-fill text-success me-2"></i>{{ tr('Powerful features') }}</li>
									</ul>
								</div>
								<!-- Content and input -->
								<div class="col-lg-5 text-lg-end mt-3 mt-lg-0">
									<a href="#" class="btn btn-warning mb-0">{{ tr('Sign Up for Free') }}</a>
								</div>
							</div> <!-- Row END -->
						</div>
					</div>
