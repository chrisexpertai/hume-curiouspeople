	...
	<div class="container">
		...
		<div class="row mb-4">
			<div class="col-12">
				<h2 class="fs-1 fw-bold">
					<span class="position-relative z-index-9">{{ tr('Our Best') }}</span>
					<span class="position-relative z-index-1">{{ tr('Instructors') }}
						<!-- SVG START -->
				...
				<p class="mb-0">{{ tr('Boost up your knowledge with industries experts') }}</p>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="tiny-slider arrow-round arrow-creative arrow-blur">
				...
				<div class="tns-outer" id="tns2-ow"><div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">17 to 20</span>  of 5</div><div id="tns2-mw" class="tns-ovh"><div class="tns-inner" id="tns2-iw">
					<div class="tiny-slider-inner  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal" data-autoplay="true" data-arrow="true" data-dots="false" data-items="4" data-items-lg="3" data-items-md="2" data-items-xs="1" id="tns2" style="transform: translate3d(-76.1905%, 0px, 0px);">
					...
					<?php foreach ($instructors as $instructor): ?>
						...
						<div class="position-relative">
							<!-- Image -->
							<img src="<?php echo $instructor->getGetPhotoAttribute(); ?>" class="card-img" alt="course image">
							<!-- Overlay -->
						...
						<div class="card-body text-center">
							<!-- Title -->
							<h5 class="card-title"><a href="<?php echo e(route('profile', $instructor->id)); ?>"><?php echo $instructor->name; ?></a></h5>
							<p class="mb-2"><?php echo e($instructor->job_title); ?></p>
							<!-- Rating -->
