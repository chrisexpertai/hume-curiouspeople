	...
	<div class="container">
		<div class="row align-items-center justify-content-xl-between g-4 g-md-5">
			...
			<div class="col-lg-7 col-xl-5 position-relative z-index-1 text-center text-lg-start mb-2 mb-md-9 mb-xl-0">
				<!-- Badge -->
				<h6 class="mb-3 font-base bg-primary bg-opacity-10 text-primary py-2 px-4 rounded-2 d-inline-block">{{ tr('Get started with Piksera') }}</h6>
				<!-- Title -->
				<h1 class="mb-4 display-5">{{ tr('Develop the skillset your') }}
					<span class="position-relative d-inline-block">{{ tr('Bright Future') }}
						<!-- SVG decoration -->
				...
				<!-- Content -->
				<p class="mb-3">{{ tr('The most reliable online courses and certifications in marketing, information technology, programming, and data science.') }}
				</p>
				<!-- Search bar -->
				<form class="border rounded p-2 mb-4">
					<div class="input-group">
						<input class="form-control border-0 me-1" type="search" placeholder="{{tr('Find your course')}}">
			...
			<div class="col-lg-5 col-xl-6 text-center position-relative">
				...
				<div class="p-3 card card-body shadow rounded-4 position-absolute top-0 start-0 translate-middle ms-5 z-index-1 d-none d-xl-block">
					<div class="d-flex justify-content-between">
						...
						<div class="text-start ms-3">
							<h6 class="mb-0">{{ tr('Java Development class') }}</h6>
							<p class="mb-0 small text-body">{{ tr('Today at 1:00 pm') }}</p>
							<!-- Button -->
							<a href="#" class="btn btn-sm btn-danger-soft mt-2 mb-0">{{ tr('Join now') }}</a>
						</div>
					</div>
				</div>
				...
				<div class="position-absolute top-100 start-100 translate-middle z-index-1 ms-n6 mt-n5 d-none d-xxl-block">
					<div class="card card-body shadow p-4 rounded-3 d-inline-block position-relative z-index-1">
						...
						<!-- Title -->
						<h6 class="mb-1 text-start">{{ tr('15K+ Students') }}</h6>
						<!-- Review -->
