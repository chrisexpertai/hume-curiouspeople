	...
	<div class="container">
		...
		<div class="row align-items-center g-5">
			...
			<div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
				...
				<!-- Title -->
				<h1 class="mb-0 display-6">{{ tr('Not Limits for Learning') }}
					<span class="position-relative">{{ tr('Forever') }}
						<!-- SVG START -->
				...
				<!-- Content -->
				<p class="my-4 lead">{{ tr('An online platform for learning and teaching with over 5,000 courses and 10 million students. These courses, taught by experts, are designed to help you develop new skills.') }}</p>

				<!-- Info -->
				<ul class="list-inline position-relative justify-content-center justify-content-lg-start mb-4">
					<li class="list-inline-item me-2"> <i class="bi bi-patch-check-fill h6 me-1"></i>{{ tr('Learn with experts') }}</li>
					<li class="list-inline-item me-2"> <i class="bi bi-patch-check-fill h6 me-1"></i>{{ tr('Get certificate') }}</li>
					<li class="list-inline-item"> <i class="bi bi-patch-check-fill h6 me-1"></i>{{ tr('Get membership') }}</li>
				</ul>

				<div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
					<!-- Button -->
					<a href="{{ route('register') }}" class="btn btn-lg btn-danger-soft me-2 mb-4 mb-sm-0">{{ tr('Get Started') }}</a>
					<!-- Video button -->
			...
			<div class="col-lg-7 col-xl-6 text-center position-relative">
				<!-- SVG decoration -->
				<figure class="position-absolute bottom-0 start-50 translate-middle-x mt-4 d-none d-lg-block mb-0">
				...
				<div class="p-3 bg-blur border border-light shadow rounded-4 position-absolute bottom-0 start-0 z-index-9 d-none d-xl-block mb-5 ms-5">
					<div class="d-flex justify-content-between align-items-center">
						...
						<div class="text-start ms-3">
							<h6 class="mb-0 text-white">{{ tr('Congratulations') }} <span class="ms-4"><i class="fas fa-check-circle text-success"></i></span></h6>
							<p class="mb-0 small text-white">{{ tr('Your admission completed') }}</p>
						</div>
					</div>
				</div>
				...
				<div class="p-3 bg-success d-inline-block rounded-4 shadow-lg position-absolute top-50 end-0 translate-middle-y mt-n7 z-index-1 d-none d-md-block" style="background:url(assets/images/pattern/01.png) no-repeat center center; background-size:cover;">
					<p class="text-white">{{ tr('Our daily new students') }}</p>
					<!-- Avatar group -->
