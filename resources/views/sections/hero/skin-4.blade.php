	...
	<div class="container pt-5 mt-0 mt-lg-5">
		...
		<div class="row position-relative mb-0 mb-sm-5 pb-0 pb-lg-5">
			<div class="col-lg-8 text-center mx-auto position-relative">
				...
				<!-- Title -->
				<h1>{{ tr('Education, talents, and career opportunities. All in one place.') }}</h1>
				<p> {{ tr('Get inspired and discover something new today. Grow your skill with the most reliable online courses and certifications in marketing, information technology, programming, and data science.') }} </p>
