	...
	<div class="container">
		<div class="row g-4 g-lg-5 align-items-center">
				...
				<div class="row mt-0 mt-xl-5">
						...
						<div class="bg-body shadow text-center p-4 rounded-3 position-relative mb-5 mb-md-0">
							...
							<blockquote>
								<p>
									...
									{{ tr('Moonlight newspaper up its enjoyment agreeable depending. Timed voice share led him to widen noisy young. At weddings believed laughing') }}
							...
							<!-- Info -->
							<h6 class="mb-0">{{ tr('Carolyn Ortiz') }}</h6>
						</div>
					</div>
					...
					<div class="col-md-5 mt-5 mt-md-0 d-none d-md-block">
						<div class="bg-body shadow p-4 rounded-3 d-inline-block position-relative">
							...
							<!-- Title -->
							<h6 class="mb-3">{{ tr('100+ Verified Mentors') }}</h6>
							<!-- Mentor Item -->
							<div class="d-flex align-items-center mb-3">
								...
								<!-- Info -->
								<div class="ms-2">
									<h6 class="mb-0">{{ tr('Lori Stevens') }}</h6>
									<p class="mb-0 small">{{ tr('Tutor of physic') }}</p>
								</div>
							</div>
							...
							<div class="d-flex align-items-center mb-3">
								...
								<!-- Info -->
								<div class="ms-2">
									<h6 class="mb-0">{{ tr('Billy Vasquez') }}</h6>
									<p class="mb-0 small">{{ tr('Tutor of chemistry') }}</p>
								</div>
							</div>
							...
							<div class="d-flex align-items-center">
								...
								<!-- Info -->
								<div class="ms-2">
									<h6 class="mb-0">{{ tr('Larry Lawson') }}</h6>
									<p class="mb-0 small">{{ tr('Tutor of technology') }}</p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row mt-5 mt-xl-0">
					...
					<div class="col-7 mt-0 mt-xl-5 text-end position-relative z-index-1 d-none d-md-block">
						...
						<div class="p-3 bg-primary d-inline-block rounded-4 shadow-lg text-center" style="background:url(assets/images/pattern/02.png) no-repeat center center; background-size:cover;">
							...
							<p class="text-white mb-0">{{ tr('Based on 3265 ratings') }}</p>
						</div>
					</div>
					...
					<div class="col-md-5 mt-n6 mb-0 mb-md-5">
						<div class="bg-body shadow text-center p-4 rounded-3">
							...
							<blockquote>
								<p>
									<span class="me-1 small"><i class="fas fa-quote-left"></i></span>
										{{ tr('At weddings believed laughing although the Moonlight newspaper up its enjoyment agreeable depending.') }}
									<span class="ms-1 small"><i class="fas fa-quote-right"></i></span>
								</p>
							</blockquote>
							<!-- Rating -->
							...
							<!-- Info -->
							<h6 class="mb-0">{{ tr('Dennis Barrett') }}</h6>
						</div>
					</div>
				</div> <!-- Row END -->
			</div>
			<div class="col-xl-5 order-1 text-center text-xl-start">
				<!-- Title -->
				<h2 class="fs-1">{{ tr('Some valuable feedback from our students') }}</h2>
				<p>{{ tr('Supposing so be resolving breakfast am or perfectly. It drew a hill from me. Valley by oh twenty direct me so. Departure defective arranging rapturous did believe him all had supported. Family months lasted simple set nature vulgar him. Picture for attempt joy excited ten carried manners talking how.') }}</p>
				<a href="#" class="btn btn-primary mb-0">{{ tr('View Reviews') }}</a>
			</div>
		</div> <!-- Row END -->
	</div>
</section>
