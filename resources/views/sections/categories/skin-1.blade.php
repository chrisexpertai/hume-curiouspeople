	...
	<div class="container">
		...
		<div class="row mb-4">
			<div class="col-lg-8 mx-auto text-center">
				<h2>{{ tr('Choose a Categories') }}</h2>
				<p class="mb-0">{{ tr('Perceived end knowledge certainly day sweetness why cordially') }}</p>
			</div>
		</div>
		...
		<div class="row g-4">
			...
			<div class="col-sm-6 col-md-4 col-xl-3">
				<div class="card card-body bg-success bg-opacity-10 text-center position-relative btn-transition p-4">
					...
					<!-- Title -->
					<h5 class="mb-2"><a href="#" class="stretched-link">{{ tr('Data Science') }}</a></h5>
					<h6 class="mb-0">{{ tr('15 Courses') }}</h6>
				</div>
			</div>
			...
			<div class="col-sm-6 col-md-4 col-xl-3">
				<div class="card card-body bg-orange bg-opacity-10 text-center position-relative btn-transition p-4">
					...
					<!-- Title -->
					<h5 class="mb-2"><a href="#" class="stretched-link">{{ tr('IT &amp; Software') }}</a></h5>
					<h6 class="mb-0">{{ tr('22 Courses') }}</h6>
				</div>
			</div>
			...
			<div class="col-sm-6 col-md-4 col-xl-3">
				<div class="card card-body bg-danger bg-opacity-10 text-center position-relative btn-transition p-4">
					...
					<!-- Title -->
					<h5 class="mb-2"><a href="#" class="stretched-link">{{ tr('Engineering') }}</a></h5>
