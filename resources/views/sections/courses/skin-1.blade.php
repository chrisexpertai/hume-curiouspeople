		...
		<div class="row mb-4">
			<div class="col-12">
				<h2 class="fs-1 fw-bold">
					<span class="position-relative z-index-9">{{ tr('Popular') }}</span>
					<span class="position-relative z-index-1">{{ tr('Courses') }}
						<!-- SVG START -->
				...
				<p class="mb-0">{{ tr('Find courses that are best for your profession') }}</p>
			</div>
		</div>
			...
			<div class="col-md-6 col-xl-4">
				<div class="card shadow-hover overflow-hidden bg-transparent">
					<div class="position-relative">
						<!-- Image -->
						<img class="card-img-top" src="<?php echo $course->thumbnail_url; ?>" href="<?php echo route('course', $course->slug); ?>" alt="Card image">
						<!-- Overlay -->
							...
							<div class="w-100 mt-auto d-inline-flex">
								<div class="d-flex align-items-center bg-white p-2 rounded-2">
									...
									<div class="avatar avatar-sm me-2">
										<img class="avatar-img rounded-1" src="<?php echo $course->author->get_photo; ?>" alt="avatar">
									</div>
									<!-- Avatar info -->
									<div>
										<h6 class="mb-0"><a href="<?php echo route('profile', $course->author->id); ?>" class="text-dark"><?php echo $course->author->name; ?><?php echo $course->author->last_name; ?></a></h6>
										<span class="small"><?php echo $course->author->job_title; ?></span>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="card-body">
						...
						<div class="d-flex justify-content-between mb-3">
							<div class="hstack gap-2">
								<a href="#" class="badge bg-orange bg-opacity-10 text-orange"><?php echo course_levels($course->level); ?></a>
								<a href="#" class="badge text-bg-dark"><?php echo date("F d, Y", strtotime($course->created_at)); ?></a>
							</div>
						...
						<ul class="list-inline">
							<li class="list-inline-item h6 fw-light mb-0"><?php echo number_format($course->rating_value, 1); ?></li>

							<?php echo star_rating_generator($course->rating_value); ?>
						...
						<div class="d-flex justify-content-between align-items-center mb-2">
							<h4 class="text-success mb-0"> <?php echo $course->paid_price(false, true); ?></h4>
							<span class="h6 fw-light mb-0 me-3"><i class="far fa-clock text-danger me-2"></i><?php echo $course->total_lectures; ?> <?php __('Lectures'); ?></span>
						</div>
					</div>
				</div>
			</div>
