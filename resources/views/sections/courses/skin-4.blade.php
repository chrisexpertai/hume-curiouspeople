		...
		<div class="row mb-4">
			<div class="col-12">
				<h2 class="fs-1 fw-bold">
					<span class="position-relative z-index-9">{{ tr('New') }}</span>
				...
				<div class="card shadow-hover overflow-hidden bg-transparent">
						...
						<div class="card-img-overlay d-flex align-items-start flex-column">
							...
							<div class="w-100 mt-auto d-inline-flex">
								<div class="d-flex align-items-center bg-white p-2 rounded-2">
									...
									<!-- Avatar info -->
									<div>
										<h6 class="mb-0"><a href="<?php echo route('profile', $course->author->id); ?>" class="text-dark"><?php echo $course->author->name; ?></a></h6>
					...
					<div class="card-body">
						...
						<div class="d-flex justify-content-between align-items-center mb-2">
							...
							<span class="h6 fw-light mb-0 me-3"><i class="far fa-clock text-danger me-2"></i><?php echo $course->total_lectures; ?></span>
						</div>
					</div>
				</div>
			</div>
