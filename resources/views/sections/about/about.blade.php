	...
	<div class="container">
		...
		<div class="row g-4">
			...
			<div class="col-10 text-center mx-auto position-relative">
				...
				<!-- Title -->
				<h1 class="position-relative fs-2">{{ tr('Piksera LMS is designed specifically for online education, focusing on providing instruction and engaging with students.') }}</h1>
			</div>
			<!-- Title and SVG END -->
		</div>
				...
				<div class="row g-4">
					...
					<div class="col-sm-6 col-md-12">
						<div class="bg-grad rounded-4 p-5 text-start">
							<span class="text-white">{{ tr('Our goal:') }}</span>
							<h3 class="text-white">“{{ tr('Be open to new ideas and approaches. Develop your problem-solving skills.') }}”</h3>
						</div>
					</div>
					<!-- Image -->
...
<section class="pt-0 pt-md-5">
	<div class="container">
		...
		<div class="row mb-4">
			<div class="col-lg-8">
				<h2>{{ tr('About Piksera Portal') }}</h2>
				<p class="mb-0">{{ tr('How promotion excellent curiosity yet attempted happiness  prosperous impression had conviction For every delay death ask to style Me mean able my by in they Extremity now strangers contained.') }}</p>
			</div>
		</div>
		...
		<div class="row align-items-center">
			...
			<div class="col-lg-7 mt-4 mt-lg-0">
				<!-- Title -->
				<h4 class="mb-3">{{ tr('5,000+ happy students joined with us to achieve their goals') }}</h4>

				<!-- Content -->
				<p>{{ tr('How promotion excellent curiosity yet attempted happiness prosperous impression had conviction For every delay death ask to style Me mean able  my by in they Extremity now strangers contained breakfast him discourse additions Sincerity collected contented led now perpetual extremely forfeited') }} </p>
				<p>{{ tr('Happiness prosperous impression had conviction For every delay in they Extremity now strangers contained breakfast him discourse additions Sincerity collected contented led now perpetual extremely forfeited') }}</p>

				<!-- Info -->
				<ul class="list-group list-group-borderless mt-4">
					<li class="list-group-item d-flex">
						<i class="bi bi-patch-check-fill text-success me-2"></i>{{ tr('Setup and installation takes less time') }}
					</li>
					<li class="list-group-item d-flex">
						<i class="bi bi-patch-check-fill text-success me-2"></i>{{ tr('Professional and easy to use software') }}
					</li>
					<li class="list-group-item d-flex">
						<i class="bi bi-patch-check-fill text-success me-2"></i>{{ tr('Perfect for any device with pixel-perfect design') }}
					</li>
					<li class="list-group-item d-flex">
						<i class="bi bi-patch-check-fill text-success me-2"></i>{{ tr('Setup and installation too fast') }}
					</li>
				</ul>
				...
				<div class="row mt-3 g-4">
					...
					<div class="col-md-6">
						<div class="overflow-hidden">
							<h6>{{ tr('Languages') }}</h6>
							<div class="progress progress-sm bg-primary bg-opacity-10">
								<div class="progress-bar bg-primary aos aos-init" role="progressbar" data-aos="slide-right" data-aos-delay="200" data-aos-duration="1000" data-aos-easing="ease-in-out" style="width: 75%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
					...
					<div class="col-md-6">
						<div class="overflow-hidden">
							<h6>{{ tr('Instructors') }}</h6>
							<div class="progress progress-sm bg-primary bg-opacity-10">
								<div class="progress-bar bg-primary aos aos-init" role="progressbar" data-aos="slide-right" data-aos-delay="200" data-aos-duration="1000" data-aos-easing="ease-in-out" style="width: 95%;" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-4 mb-4 mb-md-0">
				<!-- Title -->
				<h2>{{ tr('Awards\'N Stuff') }}</h2>
				<!-- Content -->
				<ul class="list-group list-group-borderless mt-4">
					<!-- Award item -->
					<li class="list-group-item d-flex align-items-center px-0">
						<h6 class="mb-0">{{ tr('2015') }}</h6>
						<span class="fs-6 ms-3">{{ tr('Heroes for Children award') }}</span>
					</li>
					<!-- Award item -->
					<li class="list-group-item d-flex align-items-center px-0">
						<h6 class="mb-0">{{ tr('2016') }}</h6>
						<span class="fs-6 ms-3">{{ tr('Education Agency of the Year') }}</span>
					</li>
					<!-- Award item -->
					<li class="list-group-item d-flex align-items-center px-0">
						<h6 class="mb-0">{{ tr('2017') }}</h6>
						<span class="fs-6 ms-3">{{ tr('National Teacher of the Year') }}</span>
					</li>
					<!-- Award item -->
					<li class="list-group-item d-flex align-items-center px-0">
						<h6 class="mb-0">{{ tr('2018') }}</h6>
						<span class="fs-6 ms-3">{{ tr('Best education agency 2018') }}</span>
					</li>
					<!-- Award item -->
					<li class="list-group-item d-flex align-items-center px-0">
						<h6 class="mb-0">{{ tr('2019') }}</h6>
						<span class="fs-6 ms-3">{{ tr('Teacher of the nation (2nd place)') }}</span>
					</li>
					<!-- Award item -->
					<li class="list-group-item d-flex align-items-center px-0">
						<h6 class="mb-0">{{ tr('2020') }}</h6>
						<span class="fs-6 ms-3">{{ tr('Best Independent Education Agency') }}</span>
					</li>
				</ul>
			</div>
			...
			<div class="col-md-8">
				...
				<div class="tiny-slider arrow-round arrow-creative arrow-blur arrow-hover mt-2 mt-sm-5">
					<div class="tns-outer" id="tns1-ow"><div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">{{ tr('11 to 14') }}</span>  of 5</div><div id="tns1-mw" class="tns-ovh"><div class="tns-inner" id="tns1-iw"><div class="tiny-slider-inner  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal" data-autoplay="true" data-arrow="true" data-dots="false" data-items="4" data-items-lg="3" data-items-md="2" id="tns1" style="transform: translate3d(-47.619%, 0px, 0px);"><div class="text-center tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
							...
							<!-- Info -->
							<h6 class="mb-0"><a href="#">{{ tr('Larry Lawson') }}</a></h6>
							<p class="mb-0 small">{{ tr('Designer') }}</p>
							<!-- Rating -->
							<ul class="list-inline mb-0">
								<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
								<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
							...
							<!-- Info -->
							<h6 class="mb-0"><a href="#">{{ tr('Louis Crawford') }}</a></h6>
							<p class="mb-0 small">{{ tr('Medical Professor') }}</p>
							<!-- Rating -->
							<ul class="list-inline mb-0">
								<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
								<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
							...
							<!-- Info -->
							<h6 class="mb-0"><a href="#">{{ tr('Carolyn Ortiz') }}</a></h6>
							<p class="mb-0 small">{{ tr('Designer') }}</p>
							<!-- Rating -->
							<ul class="list-inline mb-0">
								<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
							...
							<!-- Info -->
							<h6 class="mb-0"><a href="#">{{ tr('Dennis Barrett') }}</a></h6>
							<p class="mb-0 small">{{ tr('IT professor') }}</p>
							<!-- Rating -->
							<ul class="list-inline mb-0">
								<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
								<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
						...
						<!-- Avatar item -->
						<div class="text-center tns-item tns-slide-active" id="tns1-item3">
							<!-- Avatar -->
							<div class="avatar avatar-xxl mb-3">
								<img class="avatar-img rounded-circle" src="assets/images/avatar/04.jpg" alt="avatar">
							</div>
