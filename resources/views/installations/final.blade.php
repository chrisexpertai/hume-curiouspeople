...
<body>
    ...
    <div class="container text-center">
        <div class="row justify-content-center mt-5">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header"> Final Step | Import Database tables
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('finalPost') }}">
                            @csrf
                            <button type="submit" class="btn btn-primary">Run Migration & Seed</button>
                        </form>

                        <p class="text-muted mt-3"> or upload .sql manually.</p>
                    </div>
